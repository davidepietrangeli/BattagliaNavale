...
# Chiamo il metodo 'inizializza_parser()' del modulo 'inputs' per inizializzare un parser degli argomenti della riga di comando
args = inputs.inizializza_parser()
# Chiamo il metodo 'controllo_parser()' del modulo 'inputs' per controllare e gestire gli argomenti passati al programma in base alle regole definite nel parser
inputs.controllo_parser(args)

# Chiamo il metodo 'crea_nave_tipo_lista()' del modulo 'utile' per creare una lista di tipi di navi in base agli argomenti passati al programma
...
#  Chiamo il metodo 'crea_campo()' del modulo 'campo' per creare il campo di gioco per il giocatore 1
...
# Chiamo il metodo 'inizio_gioco()' del modulo 'giocatore', passando i parametri necessari per avviare il gioco
